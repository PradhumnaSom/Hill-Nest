          ...
          <div className="mb-8 flex flex-col gap-4 rounded-3xl border border-gray-200 bg-white/95 p-8 shadow-sm sm:flex-row sm:items-center sm:justify-between">
            <div>
              ...
              <p className="mt-3 max-w-2xl text-sm leading-6 text-gray-600">
                Manage your profile, review current user details, and access the booking experience from one place.
              </p>
            </div>
            ...
            <div className="flex flex-wrap items-center gap-3">
              ...
              <button
                type="button"
                onClick={() => router.push("/")}
                className="rounded-xl bg-gradient-to-r from-green-700 to-green-600 px-5 py-3 text-sm font-semibold text-white shadow-md shadow-green-900/20 transition hover:from-green-600 hover:to-green-500"
              >
                Visit home
              </button>
            </div>
            ...
            user && (
              <div className="grid gap-6 md:grid-cols-3">
                <div className="rounded-3xl border border-gray-200 bg-white p-6 shadow-sm">
                  ...
                  <p className="mt-3 rounded-full bg-green-50 px-3 py-1 text-xs font-semibold uppercase tracking-[0.2em] text-green-700">
                    {user.role}
                  </p>
                </div>
